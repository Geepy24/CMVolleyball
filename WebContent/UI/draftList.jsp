...
<script type="text/javascript">
		...
		$.ajax({
			type : "GET" ,
			url : "${pageContext.request.contextPath}/Persional/draList.action",
			data : {
				 ...
				 for(var item in backdata){
					...
					$("#rows").prepend(
							"<tr>"
								...
								+"<img src='${pageContext.request.contextPath}/UI/resources/images/icons/pencil.png' alt='编辑' /></a>"
								+"<a href=''#' title='Delete'><img src='${pageContext.request.contextPath}/UI/resources/images/icons/cross.png' alt='删除' /></a>"
								+"</td>"
							+"</tr>") ;
					...
					<div class="tab-content default-tab" id="tab1">
						...
						<div class="notification attention png_bg">
							<a href="#" class="close"><img
								src="${pageContext.request.contextPath }/UI/resources/images/icons/cross_grey_small.png"
